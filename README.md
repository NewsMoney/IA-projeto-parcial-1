...
2. Execute *Ambiente de execução → Executar tudo*. O dataset é baixado automaticamente via `kagglehub`. Se o download falhar, envie `creditcard.csv` (ver `dados/README.md`) para a pasta do Colab.
